...
1. What is the DOM?
DOM=document object model=representation of the html and css into the browser
2. What is an event?
event = js interaction with html
3. What is an event listener?
event listener = precision in js that waits fopr an event to occur. function in js that takes the event to listen for.
...
component = function in js that creates html elements and that can be added to the DOM.
